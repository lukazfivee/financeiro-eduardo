const CACHE='financeiro-cengtec-v12';
const ASSETS=['/','/index.html','/style.css','/services.css','/v02.css','/v03.css','/theme-dark.css','/theme.js','/app.js','/services.js','/cengtec-logo.png','/manifest.webmanifest'];
