const CACHE='financeiro-eduardo-v10';
const ASSETS=['/','/index.html','/style.css','/services.css','/v02.css','/v03.css','/theme-dark.css','/theme.js','/app.js','/services.js','/manifest.webmanifest'];
